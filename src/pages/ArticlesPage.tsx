...
function ArticlesPage() {
  ...
  const allCategories = Array.from(new Set(articlesData.flatMap(article => article.category)));

  // Filter articles based on selected category
  const filteredArticles = selectedCategory
    ? articlesData.filter(article => article.category.includes(selectedCategory))
    : articlesData;
        ...
        <div className="items-container">
          <div className="articles-wrapper">
            <div className="articles-header">
              <h1><FontAwesomeIcon icon={faNewspaper} /> All Articles</h1>
            ...
            <div className="articles-filter">
              <div className="filter-chips">
                <Chip
                  ...
                  className={selectedCategory === null ? 'chip-active' : ''}
                />
                {allCategories.map((category) => (
                  <Chip
                    ...
                    className={selectedCategory === category ? 'chip-active' : ''}
                  />
                ))}
              </div>
            </div>
